...
| **OpenWeatherMap** | 是 | [openweathermap.org](https://openweathermap.org/api) 免费注册（免费层） |
| **WeatherAPI.com** | 是 | [weatherapi.com](https://www.weatherapi.com) 免费注册（免费层每月 100 万次） |
...
- 环境变量在 CF 项目设置里配置：前端密钥用 `VITE_*`（构建期注入到前端）。
