...
- **多信源并排**：同时拉取多个信源的实况，逐卡展示温度、体感、湿度、风向风速、观测时间
- **首屏概览**：平均温度 + 天气状况 · 体感 + 最高/最低温，全屏天气动效背景
- **关键指标条**：湿度、降水概率、空气质量、紫外线，正常区间中性白，偏离时黄/橙/红分级着色
- **美国 AQI 对比**：多源 AQI 逐卡展示，精确到本地监测站
- **气象预警**：当前生效预警信号，按级别配色显示在首屏下方
- **分钟级降水**：未来一小时降水强度曲线（和风天气）
- **天气动效**：按天气类型 + 昼夜渲染粒子特效，含真实天文月相与月位
- **下拉刷新 / 自动刷新**：回到前台超 5 分钟或每 10 分钟自动刷新
- **iOS 原生 App**：SwiftUI + SpriteKit，功能与设计语言与 PWA 对齐，含 WidgetKit 小组件
- **Scriptable 桌面小组件**：仿苹果天气布局，显示温度 + 天气 + AQI
